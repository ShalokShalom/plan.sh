...
pkg_version=54.0
pkg_description="Language pack for Firefox"
pkg_upstream_url="http://www.mozilla.com/"
pkg_license=('MPL' 'GPL')
pkg_deps=("firefox>=$pkg_version")
...
pkg_name=()
pkg_source=()
pkg_shasum=('a712a90812ff0d9e4c1171d743c95c8e'
...
_pkg_upstream_url=https://ftp.mozilla.org/pub/mozilla.org/firefox/releases/$pkg_version/linux-x86_64/xpi

for _lang in "${_languages[@]}"; do
  _locale=${_lang%% *}
  _pkg_name=firefox-i18n-${_locale,,}

  pkg_name+=($_pkg_name)
  source+=("firefox-i18n-$pkg_version-$_locale.xpi::$_url/$_locale.xpi")
...
_do_package() {
  pkg_description="$2 language pack for Firefox"
  install -Dm644 firefox-i18n-$pkg_version-$1.xpi \
    "$pkg_prefix/usr/lib/firefox/browser/extensions/langpack-$1@firefox.mozilla.org.xpi"
}
