...
pkg_name=nvidia-bumblebee-next
_pkg_name=nvidia-bumblebee
pkg_version=381.22
pkg_description="NVIDIA drivers for linux-next. Packaged for Bumblebee"
pkg_upstream_url="http://www.nvidia.com/"
pkg_deps=('linux-next>=4.11RC7' 'linux-next<4.12' "nvidia-utils-bumblebee")
