...
pkg_name=pyqt5-python2
pkg_version=5.8.2
_snapshot=dev1604260930
pkg_description="A set of Python2 bindings for the Qt toolkit"
pkg_upstream_url="http://riverbankcomputing.co.uk/software/pyqt/intro"
pkg_license=('GPL')
pkg_deps=('sip' 'dbus-python2' 'qt5-multimedia' 'qt5-serialport' 'qt5-svg' 'qtwebkit-tp' 'pyqt5-python3')
...
do_package(){
  ...
  rm -r ${CACHE_PATH}/usr/bin
  rm -r ${CACHE_PATH}/usr/lib/qt5/plugins
