...
pkg_name=tp_smapi-next
_pkg_name=tp_smapi
pkg_version=0.42
_extramodules=/lib/modules/extramodules-4.11-next
...
pkg_source=("https://github.com/evgeni/tp_smapi/releases/download/tp-smapi%2F${pkg_version}/${_pkg_name}-${pkg_version}.tgz")
...
do_package() {
  ...
  make -C "${_extramodules%/*}/${_kernver}/build" \
    ...
    M="${CACHE_PATH}/${_pkg_name}-${pkg_version}" modules_install
