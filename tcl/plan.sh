...
do_build() {
  pushd unix > /dev/null
    ...
    sed \
      -e "s#$CACHE_PATH/unix#$pkg_prefix/lib#" \
      -e "s#$CACHE_PATH#$pkg_prefix/include#" \
      -i tclConfig.sh
    sed \
      -e "s#$CACHE_PATH/unix/pkgs/$tdbcver#$pkg_prefix/lib/$tdbcver#" \
      -e "s#$CACHE_PATH/pkgs/$tdbcver/generic#$pkg_prefix/include#" \
      -e "s#$CACHE_PATH/pkgs/$tdbcver/library#$pkg_prefix/lib/tcl${pkg_version%.?}#" \
      -e "s#$CACHE_PATH/pkgs/$tdbcver#$pkg_prefix/include#" \
      -i pkgs/$tdbcver/tdbcConfig.sh
    sed \
      -e "s#$CACHE_PATH/unix/pkgs/$itclver#$pkg_prefix/lib/$itclver#" \
      -e "s#$CACHE_PATH/pkgs/$itclver/generic#$pkg_prefix/include#" \
      -e "s#$CACHE_PATH/pkgs/$itclver#$pkg_prefix/include#" \
