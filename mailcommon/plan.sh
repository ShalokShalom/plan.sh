...
pkg_name=mailcommon
pkg_version=${_kdever}
pkg_description="Lib which provides support for mail apps"
pkg_upstream_url='https://github.com/KDE/mailcommon'
pkg_license=('LGPL')
pkg_deps=('akonadi' 'ki18n' 'kmime' 'akonadi-mime' 'kcodecs' 'kiconthemes' 'karchive' 'kitemviews'
...
#pkg_source=("git://anongit.kde.org/mailcommon.git")
#pkg_shasum=('SKIP')
