...
pkg_name=kcmutils
pkg_version=${_kdever}
pkg_description='Utilities for interacting with KCModules'
pkg_upstream_url='https://projects.kde.org/projects/frameworks/kcmutils'
pkg_license=('LGPL')
pkg_deps=('kxmlgui' 'kdeclarative' 'kpackage')
